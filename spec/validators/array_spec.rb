...
describe 'Array validator' do
  ...
  describe '#validate' do
    it 'should validate a empty array with true' do
      validator.validate(:key, [], [:array], errors)

      expect(errors).to be_empty
    end

    it 'should validate a empty array with nil spec' do
      validator.validate(:key, [], [:array, nil], errors)

      expect(errors).to be_empty
    end

    it 'should validate a empty array with empty spec' do
      validator.validate(:key, [], [:array, { }], errors)

      expect(errors).to be_empty
    end

    it 'should validate a empty array with size spec = nil' do
      validator.validate(:key, [], [:array, { size: nil }], errors)

      expect(errors).to be_empty
    end

    it 'should validate a empty array with size spec = 0' do
      validator.validate(:key, [], [:array, { size: 0 }], errors)

      expect(errors).to be_empty
    end

    it 'should validate a empty array with spec = 0' do
      validator.validate(:key, [], [:array, 0], errors)

      expect(errors).to be_empty
    end

    it 'should validate a empty array with spec = 0.0' do
      validator.validate(:key, [], [:array, 0.0], errors)

      expect(errors).to be_empty
    end

    it 'should validate a array of one item with spec = 1' do
      validator.validate(:key, [nil], [:array, 1], errors)

      expect(errors).to be_empty
    end

    it 'should validate a array of five items with {size: 5.0}' do
    ...
    it 'should not validate a empty array with size spec = 1' do
    ...
    it 'should not validate a empty array with spec = 1' do
    ...
    it 'should not validate a empty array with spec = "0" (string)' do
      validator.validate(:key, [], [:array, "0"], errors)
    ...
    it 'should not validate a empty array with spec = "1" (string)' do
      validator.validate(:key, [], [:array, "1"], errors)
    ...
    it 'should not validate a empty array with {min_size: 0} spec' do
    ...
    it 'should not validate a empty array with {min_size: 0, max_size: 2} spec' do
    ...
    it 'should not validate a array of four items with {size: 3} spec' do
    ...
    it 'should not validate a array of four items with {size: 5} spec' do
